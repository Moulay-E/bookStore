...
const BooksModal = ({ book, onClose }) => {
  return (
    ...
    >
      ...
      >
        {/*w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col realtive */}
        <AiOutlineClose
        ...
        <p className="my-2">
          cinq siècles, maisest aussi adapté à la bureautique informatique, sans
          que son contenu en soit modifié. Il a été popularisé dans les années
